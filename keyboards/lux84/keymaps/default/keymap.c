...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
    ...
    [_BASE] = LAYOUT_default(
        ...
        KC_LSFT,                KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,KC_UP,  MO(_FN1),
        KC_LCTL,KC_LGUI, KC_LALT,       KC_NO,          KC_SPC,         KC_NO,          KC_RALT, MO(_FN1), KC_RCTL, KC_LEFT,KC_DOWN, KC_RGHT),
